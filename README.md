...
**Version:** 0.17.1 · **Stack:** vanilla HTML5 Canvas + JS + CSS (no build step, no dependencies)
...
│   │   ├── perf.js            #   adaptive render quality (tiers 0–2 from measured frame time; ?q= override)
