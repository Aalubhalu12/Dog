...
{ v, createdAt, updatedAt, best, coins,
  ...
  settings: { sound, vib, tilt, control, sens, sfxVol, musicVol }, daily: { streak, last: 'YYYY-MM-DD' },
  shop: { owned: [skinIds…, 'remove_ads'], equipped, iap: [ids bought with money] }, remix: { key, best, claimed, plays, prevBest }, ftue: { done }, shop: { owned, equipped },
