...
**Version:** 0.11.0 · **Stack:** vanilla HTML5 Canvas + JS + CSS (no build step, no dependencies)
...
│       ├── map.js  # HOME + level board  map.js  play.js     # MenuScene · MapScene (level board) · PlayScene
├── data/
