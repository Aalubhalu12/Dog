...
const Assets = (() => {
  ...
  const MANIFEST = {
    ...
    forest_far: 'bg/forest_far.webp', forest_mid: 'bg/forest_mid.webp',   // theme 'forest' (levels 9–12)
    beach_far: 'bg/beach_far.webp', beach_mid: 'bg/beach_mid.webp',       // theme 'beach'  (levels 13–16)
